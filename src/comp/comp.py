...
bounds = ['C', 'D', 'E', 'F', 'G']
c = [human.name for human in humans if human.name[0] in bounds]
# for human in humans:
#     if human.name[0] in bounds:
#         c.append(human.name)
print(c)
...
# g = list(map(lambda human: Human(human.name.upper(), human.age + 5), humans))
print(g)
...
# h = list(map(lambda human: math.sqrt(human.age), humans))
print(h)
